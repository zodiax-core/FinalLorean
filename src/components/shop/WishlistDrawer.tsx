      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
              {wishlistItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center space-y-6">
                  ...
                  <p className="text-muted-foreground text-sm font-light max-w-[200px] mx-auto">
                ...
                <div className="space-y-6">
                  {wishlistItems.map((item, index) => (
                    <motion.div
                      ...
                      className="flex gap-6 p-6 rounded-[2rem] bg-card border border-border/50 shadow-sm relative group overflow-hidden"
                    >
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between mt-4">
                          ...
                          <Button
                            ...
                            className="rounded-full h-10 px-6 bg-primary hover:bg-primary/90 text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20"
                          >
            ...
            {/* Footer */}
            {wishlistItems.length > 0 && (
              <div className="p-8 border-t border-border/50 space-y-6 bg-card/10 backdrop-blur-xl">
